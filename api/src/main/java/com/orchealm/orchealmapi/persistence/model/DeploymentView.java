...
@NoArgsConstructor
@QueryFilter
public class DeploymentView extends AbstractEntity {
    ...
    @Column(name = "actual_period_start", updatable = false)
    @FilterType(type = Date.class)
    @QueryFilterField(type = Date.class)
    private OffsetDateTime actualPeriodStart;

    @Column(name = "actual_period_end", updatable = false)
    @FilterType(type = Date.class)
    @QueryFilterField(type = Date.class)
